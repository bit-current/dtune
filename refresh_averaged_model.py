...
args_2 = Configurator.combine_configs()



hf_manager = HFManager( averaged_model_repo_id=args_2.storage.averaged_model_repo_id, averaged_model_repo_local=args_2.storage.averaged_model_repo_local, \
averaged_miner_assignment_repo_local = args_2.storage.averaged_miner_assignment_repo_local, averaged_miner_assignment_repo_id = args_2.storage.averaged_miner_assignment_repo_id)
